...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_4", new String[]{"Pregunta 4.1 ¿Cuantos años tienes?", "Pregunta 4.2 ¿Tenes novio o novia?", "Pregunta 4.3¿Ganaste los parciales?", "Pregunta 4.4 ¿En que semestres vas?", "Pregunta 4.5 ¿Trabajas?", "Pregunta 4.6¿Te has caido de la moto?"});
    }
