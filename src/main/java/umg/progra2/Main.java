...
public class Main {
    ...
    private static void PruebaInsertaUsuario() {
        ...
        user.setCarne("0905-23-3945");
        user.setNombre("Manuel Monzón");
        user.setCorreo("manuelalexandermonzonpalma@gmail.com");
        user.setSeccion("A");
        user.setTelegramid(6602268509L);
        user.setActivo("Y");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Maneja la excepción de la API de Telegram y muestra el error
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        try {
         ...
         /*try {
            ...
            tareaBot poke = new tareaBot();

            botsApi.registerBot(poke);

            System.out.println("El bot esta funcionando...... MANDAR: ");
            System.out.println(" /info (Información Personal) ");
            System.out.println(" /progra (Comenstario del Curso) ");
            System.out.println(" /hola (Saludo)");
            System.out.println(" /cambio (Cambio de Euros a Quetzales)");
            System.out.println(" /grupal (Mensaje a Compañeros)");
        }
